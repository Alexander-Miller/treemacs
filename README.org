 ...
 * Dashing good looks - treemacs uses genuine xpm images in HD 22x22 resolution for its icons (quantity is, of course,
...
When run in a terminal treemacs will fall back to a much simpler rendering system, foregoing its usual xpm icons and using

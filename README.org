...
| treemacs-git-executable                  | "git"                                            | The git binary used by treemacs.                                                                                                                                                                                                     |
...
| treemacs-file-follow-ignore-functions    | nil                                              | Functions to determine which files shold not be followed.                                                                                                                                                                            |
| treemacs-buffer-name-prefix              | " *Treemacs-Buffer-"                             | Static prefix for all treemacs buffer names.                                                                                                                                                                                       |

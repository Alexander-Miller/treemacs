...
Workspace administration consits of 3 options: adding, deleting and renaming projects. See also the [[Keymap][keybinds below]].
...
Treemacs comes with a makefile that simplifies compiling and testing the codebase. It contains the following 3 targets:

...
- [[#configuration][Configuration]]
   ...
   - [[#customizing-themes-and-icons][Customizing Themes and Icons]]
      - [[#creating-and-modifying-themes][Creating and Modifying Themes]]
...
- [[#keymap][Keymap]]
   ...
   - [[#default-keymaps][Default keymaps]]
      - [[#project-keybinds-prefix-c-c-c-p][Project Keybinds (Prefix ~C-c C-p~)]]
      - [[#workspaces-keybinds-prefix-c-c-c-w][Workspaces Keybinds (Prefix ~C-c C-w~)]]
      - [[#node-visit-keybinds-prefix-o][Node Visit Keybinds (Prefix ~o~)]]
      - [[#toggle-keybinds-prefix-t][Toggle Keybinds (Prefix ~t~)]]
      - [[#copy-keybinds-prefix-y][Copy Keybinds (Prefix ~y~)]]
...
A detailed explanation on modifying themes and icons can be found in the [[Custom Themes and Icons][Configuration]] section.
** Additional Packages
...
For treemacs an extension is either the entire file name or the text after the last period. This means it can match
normal file names like "init.el", extensionless file names like "Makefile". Because the full name is checked first it is
possible to give special files their own icon, for example "Readme.md" can use a different icon than normal markdown
files.

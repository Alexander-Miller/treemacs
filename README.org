 ...
 * Ease of use :: Treemacs offers many configuration options, but comes with a set of (what hopefully should be) sane
   ...
   More on both below. You can also show the help with ~?~ that will remind you of treemacs' many keybindings
   and features.
 ...
 * First of all: press ~?~ to show the help:
   [[file:screenshots/help.png]]
...
| treemacs-help-title-face               | font-lock-constant-face                          | Face used for the title of the help.                                         |
| treemacs-help-column-face              | font-lock-keyword-face                           | Face used for the column headers of the help.                                |
| treemacs-help-key-face                 | font-lock-function-name-face                     | Face used for the keys of the help.                                           |
...
| Key      | Action                                      | Description                                                                                            |
|----------+---------------------------------------------+--------------------------------------------------------------------------------------------------------|
| ?        | treemacs-help                               | Summon the help to show you the treemacs keymap.                                              |

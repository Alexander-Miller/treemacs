 ...
 * `treemacs-change-root-without-asking` (defvault value: nil)
...
currently selected. This is achieved by advising `select-window`, which is a ubiquitous function, often called multiple
times in a row when emacs is working. This means two things:
